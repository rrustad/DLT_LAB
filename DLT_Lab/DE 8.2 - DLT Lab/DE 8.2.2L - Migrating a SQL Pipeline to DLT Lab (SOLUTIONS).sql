...
-- MAGIC 1. Comment out Widgets and magic statements
...
-- # %python
-- # print('make sure to comment me out later')
...
-- TODO
CREATE OR REFRESH LIVE TABLE recordings_enriched
(CONSTRAINT valid_heartrate EXPECT (heartrate > 0))
AS SELECT 
  ...
  FROM LIVE.recordings_bronze s
  inner join LIVE.pii on s.mrn = pii.mrn
